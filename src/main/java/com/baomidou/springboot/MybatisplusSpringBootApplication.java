...
public class MybatisplusSpringBootApplication {
    ...
    protected final static Logger logger = LoggerFactory.getLogger(MybatisplusSpringBootApplication.class);
   ...
   /* public static void main(String[] args) {
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(MybatisplusSpringBootApplication.class);
